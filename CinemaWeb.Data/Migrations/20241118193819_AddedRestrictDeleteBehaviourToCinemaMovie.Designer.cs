...
namespace CinemaWeb.Data.Migrations
{
    ...
    [Migration("20241118193819_AddedRestrictDeleteBehaviourToCinemaMovie")]
    partial class AddedRestrictDeleteBehaviourToCinemaMovie
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaWeb.Data.Models.Models.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CinemaWeb.Data.Models.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("CinemaWeb.Models.ApplicationUser", "User")
                        .WithMany("Tickets")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CinemaWeb.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
